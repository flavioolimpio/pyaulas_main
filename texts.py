class Texts:
    ...
    def text3(self):
        return '''
        <h2>Contato e Referências</h2>
        <p style='text-align: justify; color: black;'>
        Prof. Dr. Flávio Olimpio Sanches Neto<br>
        Professor Efetivo – Instituto Federal de Goiás (IFG)<br>
        Químico Industrial (UEG) – Mestre em Química (UEG) – Doutor em Físico-Química (UnB)<br>
