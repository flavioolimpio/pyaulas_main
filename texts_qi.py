class TextsQI:
    ...
    def text1(self):
        return '''
        <h1 style='text-align: center; color: black;'>Verificação de Aprendizagem - 1º Bimestre</h1>
        <p style='text-align: justify; color: black;'>Revise os conceitos fundamentais abordados no primeiro bimestre e certifique-se de compreender cada item abaixo:</p>
        <ol style='text-align: justify; color: black;'>
            <li>Postulados da Teoria Atômica de Dalton e sua importância para o entendimento da constituição da matéria. </li>
            <li>Experimento de Rutherford e o modelo nuclear do átomo, incluindo conclusões sobre a eletrosfera e o núcleo. </li>
            <li>Representação de elementos por símbolos químicos segundo Dalton e Berzelius, e a construção de fórmulas moleculares. </li>
            <li>Classificação da matéria em substâncias puras (simples e compostas) e misturas (homogêneas e heterogêneas), com exemplos do cotidiano. </li>
            <li>Estados físicos da matéria (sólido, líquido e gasoso) e principais mudanças de estado: fusão, vaporização, condensação, solidificação e sublimação. </li>
            <li>Conceito de fases em uma mistura e distinção entre misturas monofásicas e multifásicas. </li>
            <li>Propriedades macroscópicas (volume, forma, densidade) e sua relação com o comportamento das partículas. </li>
            <li>Processos de separação de misturas: decantação, filtração, centrifugação e destilação, com aplicações práticas. </li>
            <li>Importância da densidade como parâmetro para identificar substâncias em laboratório e na indústria. </li>
    ...
    <ul style='text-align: justify; color: black;'>
        <li><a href="https://phet.colorado.edu/sims/html/build-an-atom/latest/build-an-atom_pt_BR.html" target="_blank">PhET: Construa um Átomo</a> – Monte diferentes átomos interativamente.</li>
        <li><a href="https://phet.colorado.edu/sims/html/rutherford-scattering/latest/rutherford-scattering_pt_BR.html" target="_blank">PhET: Espalhamento de Rutherford</a> – Simule o experimento de Rutherford e observe desvios de partículas.</li>
        <li><a href="https://www.youtube.com/watch?v=352r_2fTh_k" target="_blank">Vídeo: Modelo Atômico de Thomson</a> – Demonstração do tubo de raios catódicos.</li>
        <li><a href="https://www.youtube.com/watch?v=e_l_y-4t3vA" target="_blank">Vídeo: Experimento de Rutherford</a> – Detalhes da descoberta do núcleo atômico.</li>
        <li><a href="https://pt.khanacademy.org/science/quimica-ensino-medio/x57f96b935ba57f4b:introducao-a-quimica/x57f96b935ba57f4b:tudo-e-feito-de-atomos/a/matter-elements-atoms-article" target="_blank">Introdução aos elementos e átomos.</a></li>
        <li><a href="https://pt.khanacademy.org/science/quimica-ensino-medio/x57f96b935ba57f4b:modelos-atomicos/x57f96b935ba57f4b:introducao-modelos-atomicos/a/daltons-atomic-theory-version-2" target="_blank">Entenda os postulados de Dalton.</a></li>
        <li><a href="https://pt.khanacademy.org/science/quimica-ensino-medio/x57f96b935ba57f4b:modelos-atomicos/x57f96b935ba57f4b:introducao-modelos-atomicos/a/discovery-of-the-electron-and-nucleus" target="_blank">Descoberta do elétron e do núcleo.</a></li>
    </ul>
    '''
    ...
    def text2(self):
        ...
        <ol style='text-align: justify; color: black;'>
            <li><strong>Semelhanças Atômicas:</strong> Entender e diferenciar os conceitos de isótopos, isóbaros, isótonos e isoeletrônicos, sabendo identificar essas relações entre diferentes átomos e íons.</li>
            <li><strong>Número Atômico (Z) e Número de Massa (A):</strong> Compreender que o número atômico define o elemento químico e que o número de massa é a soma de prótons e nêutrons.</li>
            <li><strong>Íons:</strong> Diferenciar cátions (íons positivos, perda de elétrons) de ânions (íons negativos, ganho de elétrons) e como calculá-los.</li>
            <li><strong>Organização da Tabela Periódica:</strong> Compreender a estrutura da Tabela Periódica, organizada em períodos (linhas) e grupos/famílias (colunas).</li>
            <li><strong>Propriedades Periódicas I - Raio Atômico:</strong> Definir o que é raio atômico e entender como ele varia ao longo dos períodos e grupos da Tabela Periódica.</li>
            <li><strong>Propriedades Periódicas II - Energia de Ionização:</strong> Conceituar energia ou potencial de ionização e analisar sua tendência de crescimento na Tabela Periódica.</li>
            <li><strong>Propriedades Periódicas III - Afinidade Eletrônica (Eletroafinidade):</strong> Entender o conceito de afinidade eletrônica e como essa propriedade se comporta nos grupos e períodos.</li>
            <li><strong>Propriedades Periódicas IV - Eletronegatividade:</strong> Definir eletronegatividade e saber como essa propriedade varia, identificando os elementos mais e menos eletronegativos.</li>
            <li><strong>Propriedades dos Metais, Ametais e Gases Nobres:</strong> Reconhecer as principais características e a localização desses grandes grupos na Tabela Periódica.</li>
            <li><strong>Exercícios de Aplicação:</strong> Resolver problemas que envolvam a identificação de isótopos, isóbaros e isótonos, e a previsão de propriedades periódicas com base na posição do elemento.</li>
        </ol>

        <h1 style='text-align: center; color: black;'>Atividades Complementares - 2º Bimestre</h1>
        <p style='text-align: justify; color: black;'>Explore os recursos abaixo para visualizar e aprofundar os conceitos da Tabela Periódica:</p>
        <ul style='text-align: justify; color: black;'>
            <li><a href="https://pt.khanacademy.org/science/quimica-ensino-medio/x57f96b935ba57f4b:a-tabela-periodica-dos-elementos" target="_blank">Khan Academy: A Tabela Periódica</a> – Lições completas sobre a estrutura e as propriedades periódicas.</li>
            <li><a href="https://phet.colorado.edu/sims/html/periodic-table/latest/periodic-table_pt_BR.html" target="_blank">PhET: Tabela Periódica</a> – Explore a tabela de forma interativa, visualizando tendências.</li>
            <li><a href="https://www.youtube.com/watch?v=he6lQ-ay4kE" target="_blank">Vídeo: Isótopos, Isóbaros e Isótonos</a> – Uma explicação clara sobre semelhanças atômicas.</li>
            <li><a href="https://www.youtube.com/watch?v=ycy_w_pEiM4" target="_blank">Vídeo: Propriedades Periódicas</a> – Animação que explica Raio Atômico, Energia de Ionização e Eletronegatividade.</li>
            <li><a href="https://www.tabelaperiodica.org/" target="_blank">Tabela Periódica Completa</a> – Site interativo com informações detalhadas sobre cada elemento.</li>
            <li><a href="https://brasilescola.uol.com.br/quimica/exercicios-sobre-isotopos-isobaros-isotonos.htm" target="_blank">Exercícios sobre Semelhanças Atômicas</a> – Teste seus conhecimentos com exercícios de fixação.</li>
    ...
    def text4(self):
        ...
        <h2 style='color:black;'>2) Cálculos Básicos</h2>
        <ol style='color:black; text-align: justify;'>
